...
const create_warehouse_dto_1 = require("../dto/warehouse/create-warehouse.dto");
const update_warehouse_dto_1 = require("../dto/warehouse/update-warehouse.dto");
let WarehousesController = class WarehousesController {
    ...
    findAll(name, location, isActive) {
