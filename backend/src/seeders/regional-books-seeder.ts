  ...
  async seed() {
    ...
    const regionalBooks = [
      // Türkçe Kitaplar
      {
        ...
        summary:
          'Tasavvuf edebiyatının en önemli eserlerinden biri. 25.000 beyitlik manzum eser.',
        languages: [
      ...
      },
      {
        ...
        summary:
          'Türk tasavvuf edebiyatının ilk örneklerinden. Hikmet tarzında yazılmış şiirler.',
        languages: [
          {
            languageCode: 'tr',
      ...
      // Arapça Kitaplar
      {
        ...
        summary:
          'Tasavvuf felsefesinin en kapsamlı eseri. 560 bölümden oluşur.',
        languages: [
      ...
      // Farsça Kitaplar
      {
        ...
        summary:
          'Ahlak ve edep konularında yazılmış manzum ve mensur karışık eser.',
        languages: [
      ...
      },
      {
        ...
        summary:
          'Comprehensive English translation of the Quran with commentary.',
        languages: [
          {
            languageCode: 'en',
      ...
      // Fransızca Kitaplar
      {
        ...
        summary:
          "Analyse des relations historiques entre l'Islam et l'Occident.",
        languages: [
          {
            languageCode: 'fr',
    ...
    for (const bookData of regionalBooks) {
      try {
        ...
        console.log(
          `✅ Added book: ${bookData.title} with ${languages.length} languages and ${categories.length} categories`,
        );
      } catch (error) {
