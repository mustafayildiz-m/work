  ...
  async seed() {
        ...
        translations: [
          {
            ...
            description:
              "İmam Gazali'nin en önemli eserlerinden biri. İnsanı mutluluğa götüren yolları anlatan tasavvufi bir eserdir.",
            summary:
              'Mutluluk kimyası, ibadet, ahlak ve tasavvuf konularında rehber bir eser.',
          },
          {
            languageId: english.id,
            title: 'The Alchemy of Happiness',
            description:
              "One of Imam Ghazali's most important works. A Sufi work that describes the ways that lead man to happiness.",
            summary:
              'The chemistry of happiness, a guide on worship, morals and Sufism.',
          },
          {
            languageId: arabic.id,
            title: 'كيمياء السعادة',
            description:
              'أحد أهم أعمال الإمام الغزالي. عمل صوفي يصف الطرق التي تؤدي بالإنسان إلى السعادة.',
        ...
        translations: [
          {
            ...
            description:
              "İbn Arabi'nin en önemli eserlerinden biri. Vahdet-i vücut düşüncesinin temel metinlerinden.",
            summary:
              'Peygamberlerin hikmetlerini anlatan derin bir tasavvuf eseri.',
          },
          {
            languageId: english.id,
            title: 'The Bezels of Wisdom',
            description:
              "One of Ibn Arabi's most important works. One of the basic texts of the idea of ​​unity of being.",
            summary:
              'A profound Sufi work describing the wisdom of the prophets.',
          },
          {
            languageId: arabic.id,
            title: 'فصوص الحكم',
            description:
              'أحد أهم أعمال ابن عربي. أحد النصوص الأساسية لفكرة وحدة الوجود.',
        ...
        translations: [
          {
            ...
            description:
              "Said Nursi'nin Kur'an'ın manevi tefsiri olarak kaleme aldığı eserler topluluğu.",
            summary:
              "İman, ibadet ve Kur'an tefsiri konularında kapsamlı bir eser.",
          },
          {
            languageId: english.id,
            title: 'The Risale-i Nur Collection',
            description:
              'A collection of works written by Said Nursi as a spiritual commentary on the Quran.',
            summary:
              'A comprehensive work on faith, worship and Quranic commentary.',
          },
          {
            languageId: arabic.id,
            title: 'رسائل النور',
            description:
              'مجموعة من الأعمال التي كتبها سعيد النورسي كتفسير روحي للقرآن.',
        ...
        translations: [
          {
            ...
            description:
              'Şeytanın tuzaklarından korunma yollarını anlatan önemli bir eser.',
          ...
          },
          {
            ...
            description:
              'An important work describing ways to protect from the traps of Satan.',
            summary:
              'A guide to Islamic morality and protection from the tricks of Satan.',
          },
          {
            languageId: arabic.id,
        ...
        translations: [
          {
            ...
            description:
              "Kur'an-ı Kerim'in en kapsamlı ve detaylı tefsirlerinden biri.",
            summary:
              'Kelam, felsefe ve dil bilgisi açısından zengin bir tefsir eseri.',
          },
          {
            languageId: english.id,
            title: 'Keys to the Unseen (Great Commentary)',
            description:
              'One of the most comprehensive and detailed commentaries on the Holy Quran.',
            summary:
              'A commentary work rich in terms of theology, philosophy and grammar.',
          },
          {
            languageId: arabic.id,
        ...
        translations: [
          {
            ...
            description:
              "İmam Rabbani'nin müridlerine ve çeşitli kimselere yazdığı mektuplardan oluşan eser.",
            summary:
              'Tasavvuf, şeriat-tarikat dengesi ve maneviyat üzerine öğütler.',
          },
          {
            languageId: english.id,
            title: 'Letters of Rabbani',
            description:
              'A work consisting of letters written by Imam Rabbani to his disciples and various people.',
            summary:
              'Advice on Sufism, sharia-tariqa balance and spirituality.',
          },
          {
            languageId: arabic.id,
            title: 'المكتوبات',
            description:
              'عمل يتكون من رسائل كتبها الإمام الرباني لمريديه ومختلف الناس.',
        ...
        translations: [
          {
            ...
            description:
              "Abdulkadir Geylani'nin fıkıh ve tasavvuf konularındaki temel eseri.",
            summary:
              'Müridlerin rehberi, fıkıh ve tasavvuf bilgileri içeren kapsamlı eser.',
          },
          {
            languageId: english.id,
            title: 'Sufficient Provision for Seekers',
            description:
              "Abdulkadir Geylani's basic work on jurisprudence and Sufism.",
            summary:
              'A comprehensive work containing the guide of disciples, jurisprudence and Sufism knowledge.',
          },
          {
            languageId: arabic.id,
            title: 'غنية الطالبين',
        ...
        translations: [
          {
            ...
            title: 'el-Ümm',
            description:
              "İmam Şafii'nin fıkıh usulü ve fıkhi meseleleri ele aldığı ana eseri.",
            summary:
              'Şafii mezhebinin temel kaynağı, fıkıh ve usul konularında referans eser.',
          },
          {
            languageId: english.id,
            title: 'The Mother Book',
            description:
              "Imam Shafi's main work dealing with the principles of jurisprudence and jurisprudence issues.",
            summary:
              'The main source of the Shafi school, reference work on jurisprudence and methodology.',
          },
          {
            languageId: arabic.id,
            title: 'الأم',
            description:
              'العمل الرئيسي للإمام الشافعي الذي يتناول أصول الفقه والمسائل الفقهية.',
            summary:
              'المصدر الرئيسي للمذهب الشافعي، عمل مرجعي في الفقه والمنهجية.',
          },
        ],
      },
      {
        ...
        translations: [
          {
            ...
            title: 'Mukaddime',
            description:
              "İbn Haldun'un toplum ve medeniyet tarihi üzerine çığır açan eseri.",
            summary:
              'Sosyolojinin temellerini atan, medeniyet ve devlet teorileri içeren klasik eser.',
          },
          {
            languageId: english.id,
            title: 'The Muqaddimah',
            description:
              "Ibn Khaldun's groundbreaking work on the history of society and civilization.",
            summary:
              'A classic work that lays the foundations of sociology and contains theories of civilization and state.',
          },
          {
            languageId: arabic.id,
            title: 'المقدمة',
            ...
            summary:
              'عمل كلاسيكي يضع أسس علم الاجتماع ويحتوي على نظريات الحضارة والدولة.',
          },
        ],
      },
      {
        ...
        translations: [
          {
            ...
            description:
              "İmam Gazali'nin entelektüel ve ruhani yolculuğunu anlattığı otobiyografik eseri.",
          ...
          },
          {
            ...
            description:
              "Imam Ghazali's autobiographical work describing his intellectual and spiritual journey.",
            summary:
              'Deliverance from error and doubt, the adventure of reaching the truth.',
          },
          {
            languageId: arabic.id,
            title: 'المنقذ من الضلال',
            description:
              'العمل السيري الذاتي للإمام الغزالي الذي يصف رحلته الفكرية والروحية.',
    ...
    for (const bookData of religiousBooks) {
      try {
        ...
        addedCount++;
        console.log(
          `✅ Kitap eklendi: ${bookData.translations[0].title} (${bookData.categories.join(', ')})`,
        );
      } catch (error) {
        console.error(
