...
import { BsMicFill, BsCheckLg, BsArrowRight, BsSearch, BsXCircleFill, BsArrowLeft } from 'react-icons/bs';
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="cs-country__count">
                        {t('podcasts.countrySelector.itemsCountPhrase', { count: String(podcastCounts[lang.code] || 0) })}
                      </div>
                      {isLangSelected && (
            ...
            <div ref={continueButtonRef} className="cs-action">
              ...
              <p className="cs-action__meta">
                {t('podcasts.countrySelector.availableLine', {
                  count: String(podcastCounts[selectedLanguage.code] || 0),
                })}
              </p>
            </div>
          )}
