...
import { BsMicFill, BsPlayFill, BsPauseFill, BsHeart, BsSearch, BsClock, BsEye, BsStarFill, BsFilter, BsArrowLeft, BsGrid3X3Gap, BsList, BsChevronDown, BsChevronUp } from 'react-icons/bs';
...
export default function PodcastsListPage() {
  ...
  return (
    <Col lg={9}>
      ...
      {/* Sticky Audio Player */}
      {currentlyPlaying && (
        <Card className="mb-4 border-0 shadow-lg position-sticky" style={{ top: '80px', zIndex: 100 }}>
          <CardBody className="p-3">
            <Row className="align-items-center">
              ...
              <Col xs={7} md={9}>
                <div>
                  <h6 className="mb-0 text-truncate">{currentlyPlaying.title}</h6>
                  <small className="text-muted">{currentlyPlaying.author}</small>
                </div>
              </Col>
