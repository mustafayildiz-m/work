...
const AboutCard = () => {
  return <Card>
      ...
      <CardBody className="position-relative pt-0">
        <p>Destek almak isteyen spor meraklıları için harika bir topluluk.</p>
        <ul className="list-unstyled mt-3 mb-0">
          <li className="mb-2">
            {' '}
            <BsCalendarDate className="fa-fw pe-1" /> Kişi sayısı: <strong>20 Üye</strong>{' '}
          </li>
          <li className="mb-2">
            {' '}
            <BsHeart className="fa-fw pe-1" /> Durum: <strong>Herkese Açık</strong>{' '}
          </li>
          <li className="mb-2">
            {' '}
          ...
          <div className="d-md-flex flex-wrap align-items-start text-center text-md-start">
            ...
            <div className="ms-md-4 mt-3">
              <h1 className="h5 mb-0">
                Apple Eğitim <BsPatchCheckFill className="text-success small" />
              </h1>
              <ul className="nav nav-divider justify-content-center justify-content-md-start">
                <li className="nav-item"> Gizli Grup </li>
                <li className="nav-item"> 28.3K üye </li>
              </ul>
            </div>
