            ...
            <div className="ms-2">
              ...
              <ul className="nav nav-divider py-2 small">
                ...
                {children?.length && children?.length > 0 && <li className="nav-item">
                    <Link className="nav-link" href="">
                      {' '}
                      {children?.length} Yanılatı görüntüle
                    </Link>
                  </li>}
              </ul>
            </div>
  ...
  return <Card>
          ...
          <div className="d-flex align-items-center">
            ...
            <div>
              <div className="nav nav-divider">
                ...
                <span className="nav-item small"> {timeSinceTurkish(createdAt)}</span>
              </div>
      ...
      <CardBody>
        ...
        <ul className="nav nav-stack py-3 small">
          <li className="nav-item">
            <Link className="nav-link active" href="" data-bs-container="body" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" data-bs-custom-class="tooltip-text-start" data-bs-title="Frances Guerrero<br> Lori Stevens<br> Billy Vasquez<br> Judy Nguyen<br> Larry Lawson<br> Amanda Reed<br> Louis Crawford">
              {' '}
