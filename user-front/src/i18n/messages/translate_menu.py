...
def main():
    ...
    for filename in json_files:
        ...
        for key in keys_to_translate:
            ...
            english_vals = ['My Network', 'Stories', 'Booklets', 'Papers']
            if not current_value or current_value in english_vals or current_value == source_value:
                print(f"   📝 menu.{key} DeepL ile çevriliyor...")
