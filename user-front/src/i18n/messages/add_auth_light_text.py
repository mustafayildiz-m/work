...
en_texts = {
    ...
    "pathToLightP4": "Inshaallah, we also wish to deliver these valuable books to you and to bring you together with the Ahl as-Sunnah Scholars (Rahmatullahi Alaihim Ecmain) through bond of love."
}
...
tr_texts = {
    ...
    "pathToLightP4": "Bizde sizleri bu kıymetli kitaplarla ve bu kitapları hazırlayan Ehli Sünnet Alimleri (Rahmetullahi Aleyhim Ecmain) muhabbet yolu ile tanıştırmak istiyoruz.\""
}
