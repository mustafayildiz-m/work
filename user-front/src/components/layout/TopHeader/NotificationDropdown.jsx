      ...
      <DropdownMenu className="dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0">
        <Card>
          <CardHeader className="d-flex justify-content-between align-items-center">
            <h6 className="m-0">
              Bildirimler <span className="badge bg-danger bg-opacity-10 text-danger ms-2">4 yeni</span>
            </h6>
              ...
              {allNotifications.slice(0, 4).map((notification, idx) => <li key={idx}>
                ...
                'badge-unread': !notification.isRead
                    ...
                    <div className="avatar text-center">
                      {notification.avatar ? <Image className="avatar-img rounded-circle" src={notification.avatar} alt="" /> : <div className={`avatar-img rounded-circle bg-${notification.textAvatar?.variant}`}>
