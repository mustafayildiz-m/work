...
function EditPaper() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Yayin guncellendi');
      navigate('/akademik-yayinlar/liste');
    } catch (error) {
      toast.error(error.message || 'Yayin guncellenemedi');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Helmet>
        <title>Akademik Yayin Duzenle</title>
      </Helmet>

      <div className="p-6 max-w-5xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Akademik Yayin Duzenle</h2>
          <Link
