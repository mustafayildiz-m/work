  ...
  const handleTranslationChange = (idx, field, value) => {
    const newTranslations = form.translations.map((trans, i) => {
      ...
      if (field === 'countryId') {
        ...
        if (langs.length > 1) {
          updatedTrans.languageId = '';
          updatedTrans._countryLangs = langs;
        } else {
          updatedTrans.languageId = country?.primaryLanguage?.id || '';
          updatedTrans._countryLangs = null;
        }
      }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        isClearable
                      />
                      {trans._countryLangs && trans._countryLangs.length > 1 ? (
                        <div className="mt-2">
                          ...
                          <select
                            ...
                            onChange={e => handleTranslationChange(idx, 'languageId', Number(e.target.value) || '')}
