...
export function UserHero({ image, name, info, coverImage, onCoverImageEdit, showEditButton = false }) {
  ...
  return (
    <div className="relative">
      {/* Cover Image */}
      <div className="relative h-48 lg:h-64 bg-center bg-cover bg-no-repeat rounded-t-xl overflow-hidden">
        {coverImage ? (
          <img
            src={coverImage}
            alt="Cover"
